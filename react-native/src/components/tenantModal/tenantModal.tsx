        ...
        >
            <View style={styles.modalBackground}>
                <View style={styles.card}>
                    ...
                    >
                        <Icon type="AntDesign" name="closecircle" style={{ fontSize: 30 }} />
                    </TouchableOpacity>
                    <Formik
                        initialValues={{ tenantName: 'admin' }}
                        validationSchema={yup.object().shape({
                            tenantName: yup.string().required(),
                        })}
                        validateOnChange={true}
                        onSubmit={value => isTenantAvaible(value.tenantName)}
                    >
                        {({ handleChange, values, handleSubmit, errors, handleBlur }) => (
                            <>
                                ...
                                <Button warning style={styles.button} onPress={handleSubmit}>
