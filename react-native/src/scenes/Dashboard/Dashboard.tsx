      ...
      <View style={styles.container}>
        <View style={styles.flexRow}>
          <View style={[styles.card, styles.dasboardCardtask]}>
            <View style={styles.flexRow}> 
              <Icon type="AntDesign" name="check" style={{ color: "white",marginRight:5 }}></Icon>
          ...
          <View style={[styles.card, styles.dasboardCardTicket]}>
            <View style={styles.flexRow}>
              <Icon type="AntDesign" name="question" style={{ color: "white",marginRight:5 }}></Icon>
        ...
        <View style={styles.flexRow}>
          <View style={[styles.card, styles.dasboardCardComment]}>
            <View style={styles.flexRow}>
              <Icon type="AntDesign" name="message1" style={{ color: "white",marginRight:5 }}></Icon>
          ...
          <View style={[styles.card, styles.dasboardCardVisitor]}>
            <View style={styles.flexRow}>
              <Icon type="AntDesign" name="adduser" style={{ color: "white",marginRight:5 }}></Icon>
